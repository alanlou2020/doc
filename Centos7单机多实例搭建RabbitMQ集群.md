### Centos7单机多实例搭建RabbitMQ高可用集群

> ==注意：此集群方案主节点不能挂，主节点挂了，所有的从节点也都不可用了。==

##### 1、在Centos上安装好RabbitMQ，并在防火墙中开放端口：5672,15672，此过程略过。。。
...
```shell
[root@alanCentos01 /]# rabbitmq-plugins enable rabbitmq_management
Enabling plugins on node rabbit@alanCentos01:
rabbitmq_management
...
Applying plugin configuration to rabbit@alanCentos01...
